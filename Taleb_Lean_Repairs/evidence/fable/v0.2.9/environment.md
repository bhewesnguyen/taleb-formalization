# Environment record (Fable review, v0.2.9)

Recorded: 2026-09-21T04:34:42Z. Same host as ../baseline/environment.md.
...
- lean-toolchain: leanprover/lean4:v4.24.0; lakefile.toml version 0.2.9
...
|---|---|---|---|---|
| 01_lake_build | rm -rf .lake/build; lake build | 0 | 104 | 01_lake_build.log |
| 02_verify_py | python3 scripts/verify.py | 0 | 183 | 02_verify_py.log |
| 03_harness_regression | python3 scripts/harness_regression.py | 0 | ~2840 | 03_harness_regression.log |
| 04_backlog_schema_probes | python3 scripts/backlog_schema_probes.py | 0 | <1 | 04_backlog_schema_probes.log |

## Result
- lake build (project .lake/build removed first): `Build completed successfully`; 31 project modules Built; 0 warnings/errors.
- verify.py: `PASS: 181 theorems, 8 instance, 16 aliases; no extra axioms; trust scan: 361 project constants (incl. 101 internal) all within allowlist; 205 public theorem/instance constants match the regex inventory` — includes the byte-literal check that docs/FORMALIZATION_BACKLOG.md equals render_markdown(JSON).
- harness_regression.py: 14 fixtures, all behaved as expected: True; pristine source-tree sha256 90be35dda5cf075df71c169d6fe3972b818a8dc92e82cacc7e6a597b186db940; every fixture restored to that hash with .lake/build reset from the pristine snapshot before mutation; real project mutated: False.
- backlog_schema_probes.py: 18 probe results, 18 behaved as expected, all: True (count taken from the machine-readable record).
- deliverables_index_at_packaging.md: copy of the repository's deliverables index at packaging time (audit of v0.2.8: the D027-3 annotation was not inspectable from the bundle because the deliverables commit post-dates it).

## Source hashes of every Lean file (from verification.json)
- eb22f80e0c89c55442685510236f48870921a0b651d04a918c6f3e2c0386f0ea  AuditRepairs.lean
...
- b42e4b803824e6911a65248a2be45cea06a7188bcea9dc8145ed2a4c92d51cd7  AuditVerification.lean
