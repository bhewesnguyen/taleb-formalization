# Environment record (Fable review, v0.2.5)

Recorded: 2026-09-19T18:25:07Z. Same host as ../baseline/environment.md.
...
- lean-toolchain: leanprover/lean4:v4.24.0; lakefile.toml version 0.2.5
...
|---|---|---|---|---|
| 01_lake_build | rm -rf .lake/build; lake build | 0 | 48 | 01_lake_build.log |
| 02_verify_py | python3 scripts/verify.py | 0 | 94 | 02_verify_py.log |
| 03_harness_regression | python3 scripts/harness_regression.py | 0 | 1237 | 03_harness_regression.log |

## Result
- lake build (project .lake/build removed first): `Build completed successfully`; 27 project modules Built; 0 warnings/errors.
- verify.py: `PASS: 103 theorems, 3 instance, 16 aliases; no extra axioms; trust scan: 216 project constants (incl. 49 internal) all within allowlist; 122 public theorem/instance constants match the regex inventory`
- harness_regression.py: 12 fixtures, all behaved as expected: True; pristine source-tree sha256 6668b07d8dfd62b542d069ca75ba7010f1c6c6f27f942a85ae81b019b3790e16; every fixture restored to that hash with .lake/build reset from the pristine snapshot before mutation.
- CLI probes for audit findings H1/H2: cli_probes/ (malformed --only rejected with exit 2 and no scratch created; relative --scratch run of the valid fixture PASS).

## Source hashes of every Lean file (from verification.json)
- 6142ec19c9b8a78c8bdef0286d991236459d8400f4b1ad4659a4c855c13c6da8  AuditRepairs/ExtremeValueBridge.lean
- b3d3e3af1c12c718af109b9191e1369d935410d4dee75c8a3cfb7c796df31b6c  AuditRepairs/ExtremeValueLaws.lean
...
- 0f62239ac0d54ffc1a503031f905caa919fbedd5a993b6acbc3524b68573fed4  AuditRepairs.lean
- 2998858702acff98df4238145a2cb5996077e678e70a33dcec41b1cb1832677c  AuditVerification.lean
