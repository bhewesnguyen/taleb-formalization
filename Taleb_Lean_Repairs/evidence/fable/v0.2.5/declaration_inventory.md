# Final declaration inventory (Fable review, v0.2.5)
...
- Project constants scanned: **216** = 122 public user-written theorem/instance + 25 public user-written defs + 1 structure type + 19 Lean-generated public constants + 49 internally named constants.
- Public user-written theorem/instance constants: **122** = 103 theorems + 3 instances + 16 aliases; equals the `#print axioms` set of `AuditVerification.lean` (122).
- Axiom closures over all scanned constants: `['Classical.choice', 'Quot.sound', 'propext']` x199; `['propext']` x13; `[]` x4. No `sorryAx`; no project `axiom`.
- Imported project modules: 26; backlog: 158 families, 1 discharged, 83 citations over 82 distinct declarations, schema valid.

## Count reconciliation

| quantity | v0.2.0 | v0.2.1 | v0.2.2 | v0.2.3 | v0.2.4 | v0.2.5 |
|---|---|---|---|---|---|---|
| theorem declarations (regex) | 50 | 52 | 52 | 64 | 83 | **103** |
| instances | 1 | 1 | 1 | 1 | 1 | **3** |
| aliases | 16 | 16 | 16 | 16 | 16 | 16 |
| checked declarations | 67 | 69 | 69 | 81 | 100 | **122** |
| environment: constants axiom-checked | 100 | 102 | 137 | 158 | 189 | **216** (167 + 49 internal) |
| new in v0.2.5 | | | | | | 20 theorems, 2 instances, 4 defs in `AuditEVTLaws` (Gumbel and Fréchet measures, cdf identities, max-stability instantiated, product-space realizations) |
