# Final declaration inventory (Fable review, v0.2.3)
...
- Project constants scanned: **158** = 81 public user-written theorem/instance + 16 public user-written defs + 1 structure type + 19 Lean-generated public constants + 41 internally named constants.
- Public user-written theorem/instance constants: **81** = 64 theorems + 1 instance + 16 aliases; equals the `#print axioms` set of `AuditVerification.lean` (81).
- Axiom closures over all scanned constants: `['Classical.choice', 'Quot.sound', 'propext']` x141; `['propext']` x13; `[]` x4. No `sorryAx`; no project `axiom`.
- Imported project modules: 25.

## Count reconciliation

| quantity | v0.2.0 | v0.2.1 | v0.2.2 | v0.2.3 |
|---|---|---|---|---|
| theorem declarations (regex) | 50 | 52 | 52 | **64** |
| instances | 1 | 1 | 1 | 1 |
| aliases | 16 | 16 | 16 | 16 |
| checked declarations | 67 | 69 | 69 | **81** |
| environment: constants axiom-checked | 100 (public/generated) | 102 | 137 | **158** (117 + 41 internal) |
| new in v0.2.3 | | | | 12 theorems, 3 defs (`varianceOfScale`, `gaussianParameters`, `maxLeEvent`): `AuditTails.two_power_tail(_min)`, `AuditGaussian.*`, `AuditExtremes.*` |
