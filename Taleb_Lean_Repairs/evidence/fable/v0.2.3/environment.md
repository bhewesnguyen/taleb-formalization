# Environment record (Fable review, v0.2.3)

Recorded: 2026-09-19T02:43:32Z. Same host as ../baseline/environment.md.
...
- lean-toolchain: leanprover/lean4:v4.24.0; lakefile.toml version 0.2.3
...
|---|---|---|---|---|
| 01_lake_build | rm -rf .lake/build; lake build | 0 | 35 | 01_lake_build.log |
| 02_verify_py | python3 scripts/verify.py | 0 | 73 | 02_verify_py.log |
| 03_harness_regression | python3 scripts/harness_regression.py | 0 | 798 | 03_harness_regression.log |

## Result
- lake build (project .lake/build removed first): `Build completed successfully`; 26 project modules Built; 0 warnings/errors.
- verify.py: `PASS: 64 theorems, 1 instance, 16 aliases; no extra axioms; trust scan: 158 project constants (incl. 41 internal) all within allowlist; 81 public theorem/instance constants match the regex inventory`
- harness_regression.py: 10/10 fixtures behaved as expected.

## Source hashes of every Lean file (from verification.json)
- 894c116afc34cc39e37a7abf9fd38a6a1b1064aea0c787ff9f3a6226cbb53fa8  AuditRepairs/ExtremeValueBridge.lean
- 5ecb7943038eae5e36fe6189aa1731c7abf2a7d8315af06f2caa8feaab8bb959  AuditRepairs/Foundations.lean
- 2bd9c425c7913d72c44e2cc036fe8082f035fab8cc88af40e76deda571919cf1  AuditRepairs/GaussianBridge.lean
...
- 4b22f683610a8aba9825f289612408baa076d8c80047ddf3b70cfe9fa775088d  AuditVerification.lean
